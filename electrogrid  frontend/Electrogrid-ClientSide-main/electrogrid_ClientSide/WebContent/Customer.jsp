...
<script src="components/main.js"></script>
 ...
 <nav class="navbar navbar-expand-md navbar-dark" style="background-color: 	#5353ff">
                    ...
                    <ul class="navbar-nav">
                        <li><a href="Index.jsp" class="nav-link">Electro grid Online Platform</a></li>
                    </ul>
                 </nav>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6>About</h6>
            <p class="text-justify">Thambavita K.N <i> </i> This project is based on a company named a Electro grid who funds inventors and motivate them by letting them sell their products in the companies online platform. My task was to create the online platform covering the whole scope of the company. I used java , tomcat , mysql and JAX-RS Restful webservice as our tools to create our platform..</p>
          </div>
